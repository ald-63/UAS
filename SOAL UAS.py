# -*- coding: utf-8 -*-
"""
Created on Mon Jul 12 13:01:24 2021
UAS ALGORITMA PEMROGRAMAN – SMT 2 – JULI 2021
...
while JawabUlang=="y" or JawabUlang=="Y":
    ...
    #siapkan variabel
    Gol = [1,2,3]
    GjPokok = [2500000, 4500000, 6500000]
    ...
    while idx < 4:
        ...
        if pilihJK == 'Laki - Laki' and pilihSK == 'Kawin' :
            ...
            while x < len(Gol):
                if Gol[x] == idx:
                    DptTunjIstri = TunjIstri[x]
                    totalTunjanganIstri = Gapok * DptTunjIstri
                x += 1
        else :
...
file.write("Tanggal : " + format(tgl) + "\r")
file.write("=====================================================\r")
